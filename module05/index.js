 ...
 */
const getAllNames = arr => arr.map(arrNew => arrNew.name);;
 ...
 */
const getUsersByEyeColor = (arr, color) => arr.filter(arrNew => arrNew.eyeColor === color);
 ...
 */
const getUsersByGender = (arr, gender) => arr.filter(arrNew => arrNew.gender === gender).map(arrNew => arrNew.name);;
 ...
 */
const getInactiveUsers = arr => arr.filter(arrNew => !arrNew.isActive);
 ...
 */
const getUsersWithAge = (arr, min, max) => arr.filter(arrNew => arrNew.age > min && arrNew.age < max);
 ...
 */
const getUsersByFriend = (arr, name) => arr.filter(arrNew => arrNew.friends.includes(name));
